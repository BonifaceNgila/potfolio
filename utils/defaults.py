def default_cv_data() -> dict:
    return {
        ...
        "profile_summary": (
            "Highly versatile IT professional and web developer with an M.Sc. in Computer "
            "Science now awaiting graduation. Experienced at the intersection of system "
            "administration and software engineering, with a proven track record managing "
            "secure, high-availability infrastructure and Identity & Access Management (IAM) "
            "for global organizations such as Plan International. Skilled in full-stack "
            "development (PHP, Python, JavaScript) and experienced integrating AI/LLMs into "
            "practical tools, including automated code reviewers and data management systems. "
            "OCI DevOps Professional and Architect Associate certified, with a security-first "
            "approach to infrastructure monitoring and application development. Committed to "
            "driving organizational success through automation, cybersecurity practices, and "
        ...
        "core_competencies": [
            ...
            "Kubernetes Orchestration: Manages the deployment of Deployments, StatefulSets, and ReplicaSets while optimizing pod placement and health via nodeSelectors and Probes.",
            "Networking & Security: Implements stable communication using Services, executes role-oriented routing with Gateway API, and enforces RBAC security through ServiceAccounts.",
            "Infrastructure Optimization: Automates scaling via Horizontal Pod Autoscaler (HPA), manages TLS with cert-manager, and secures the supply chain using SBOMs and multi-stage builds.",
        ...
        "education": [
            {
                "course": "Cloud Computing Security Engineering",
        ...
        "projects": [
            {
                ...
                "description": "PHP/MySQL web application for tracking organizational assets and related workflows, with multi-role users, scoped access, asset verification windows, disposals, and reporting.",
            ...
            },
            {
                ...
                "description": "Full-stack PHP/MySQL application for managing Sickle Cell Disease screening programs, patients, facilities, test kits, screening results, analytics, and role-based access control.",
            ...
            },
            {
                ...
                "description": "AI coding assistant that uses the DeepSeek-Coder model through Ollama to analyze code and provide feedback, improvement suggestions, and bug-fix guidance.",
            ...
            },
            {
                ...
                "description": "Vision-language application that uses the LLaVA model through Ollama to generate descriptive captions for uploaded images.",
